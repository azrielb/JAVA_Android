	...
	<%
		if (request.getParameter("add") != null) {
			try {
				...
				order.setTechnicianID((int) (long) (BackendFactory
						.getInstance().getTechnicianByName(technicianName)
						.getId()));
				order.setAddres(addres);
				BackendFactory.getInstance().addOrder(order);
	%>
			...
			<table>
				...
				<tr>
					...
					<td><select name="technicianName">
							<%
								for (Technician t : BackendFactory.getInstance()
										.getAllTechnichians()) {
							%>
